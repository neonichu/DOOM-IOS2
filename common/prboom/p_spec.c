...
void P_CrossSpecialLine(line_t *line, int side, mobj_t *thing)
{
  ...
  switch (line->special)
  {
    ...
    case 2:
      // Open Door
      if (EV_DoDoor(line,open_) || demo_compatibility)
        line->special = 0;
      break;

    case 3:
      // Close Door
      if (EV_DoDoor(line,close_) || demo_compatibility)
        line->special = 0;
      break;

    case 4:
      // Raise Door
      if (EV_DoDoor(line,normal_) || demo_compatibility)
        line->special = 0;
      break;
